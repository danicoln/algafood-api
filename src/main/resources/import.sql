...
insert into restaurante (id, nome, taxa_frete, cozinha_id, forma_pagamento_id) values (1, 'Matuto', 9.99, 1, 1);
insert into restaurante (id, nome, taxa_frete, cozinha_id, forma_pagamento_id) values (2, 'Madero', 7.50, 1, 2);
insert into restaurante (id, nome, taxa_frete, cozinha_id, forma_pagamento_id) values (3, 'Delivery Foods', 15.50, 2, 3);
